...
if(isset($_GET['ref'])){
    ...
    $confirm_ref = User::find_sql("SELECT user_id FROM agents WHERE user_id=(SELECT id FROM users WHERE ref_id='{$ref}')");
    if($db_init->num_rows($confirm_ref)==1){
        $_SESSION['ref'] = $ref;
        echo "<script> alert_func('success', 'Agent Id $ref identified!', 'signup.php'); </script>";
    }else{
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-sm-8 contact-block">
                    ...
                    <form action="#" method="POST" id="contact-form" autocomplete="on">
                        ...
                        <div class="form-group col-sm-6 padding-right">
                                ...
                                <input type="text" class="form-control" name="lname" id="lname" required placeholder="agent reference / promotion code" disabled value="<?php if(isset($_SESSION['ref'])){echo $_SESSION['ref'];}else{echo 'GPseDxW8C7Mu';}?>">
